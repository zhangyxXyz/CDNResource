...
var ipInnerInit=document.createElement("script");ipInnerInit.type="text/javascript",ipInnerInit.referrerPolicy="no-referrer"
ipInnerInit.src='https://whois.pconline.com.cn/jsFunction.jsp?&callback=f'+t.get("objectId")+'&level=2&ip='+(ip&&ip!==''?ip:'127.0.0.1');try{regfunc(t.get("objectId"))
