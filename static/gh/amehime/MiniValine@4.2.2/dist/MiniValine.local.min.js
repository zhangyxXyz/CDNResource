!function(e, t) {
    ...
    window.regfunc = function(f) {
        window['f' + f] = function(l) {
            document.getElementById("ip-" + f).innerHTML = "&nbsp;来自『" + ((l && l != '') ? l : '火星') + "』"
        }
    }
    return function(e) {
        function t(t) {
        ...
        ,
        a.p = "http://localhost:4000/resource/static/gh/amehime/MiniValine@4.2.2/dist/",
        a.oe = function(e) {
    ...
    , function(e, t, n) {
        ...
        t.EUrl = ['http://localhost:4000/resource/static/npm/alus@latest', 'http://localhost:4000/resource/static/gh/MiniValine/qq@master', 'http://localhost:4000/resource/static/gh/MiniValine/Bilibilis@master', 'http://localhost:4000/resource/static/gh/MiniValine/tieba@master', 'http://localhost:4000/resource/static/gh/MiniValine/twemoji@master', 'http://localhost:4000/resource/static/gh/MiniValine/weibo@master', ],
        t.pf = "https://cdn.polyfill.io/v3/polyfill.min.js?features=es6",
        t.i18nUrl = "http://localhost:4000/resource/static/gh/MiniValine/minivaline-i18n@latest/",
        ...
        e.exports = function(e, t) {
            ...
            if (o && !e.config.closeUA) {
                ...
                try {
                    ...
                    var ipInnerInit = document.createElement("script");
                    ipInnerInit.type = "text/javascript",
                    ipInnerInit.text = `fetch("https://ip.zxinc.org/api.php?type=json&ip=${ip && ip !== '' ? ip : '127.0.0.1'}").then(function(response){return response.json();}).then(function(info){${'f' + t.get("objectId")}((info?.data?.country || "").replace('\t', ' '));})`;
                    try {
                        regfunc(t.get("objectId"))
                        document.getElementsByTagName("head")[0].appendChild(ipInnerInit)
                    } catch (e) {}
                } catch (e) {}
            }
            var c = "";
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            window.autosize || t.push("npm/autosize@5.0.1/dist/autosize.min.js"),
            window.filterXSS || t.push("npm/xss@1.0.11/dist/xss.min.js"),
            e.config.closeUA || window.UAParser || t.push("npm/ua-parser-js@1.0.2/dist/ua-parser.min.j"),
            !e.math && void 0 !== e.config.math || "undefined" != typeof MathJax || t.push("npm/mathjax@3.2.1/es5/tex-svg.js"),
            !e.md && void 0 !== e.config.md || window.marked || t.push("npm/marked@1.2.0/lib/marked.min.js"),
            (0,
            i.default)("http://localhost:4000/resource/static/combine/third/valine/parse.js", (function() {
                e.initBody(),
            ...
            window.AV || t.push("npm/leancloud-storage@4.12.2/dist/av-min.js"),
            (0,
            i.default)("http://localhost:4000/resource/static/combine/third/valine/parse.min.js", (function() {
                e.initCheck(),
        ...
        e.exports = function(e) {
            ...
            e.submitEvt = function(i) {
                ...
                t.getAttribute("disabled") ? e.alert.show({
                    ...
                    e.C.comment = e.C.comment.replace(/<img src=".*?(\/resource\/static\/)/g, "<img src=\"https://cdn.onlyzyx.com/static/"),
    ...
    , function(e, t, n) {
        ...
        e.exports = {
            mail: function(e) {
                return {
                    k: /^([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+\.[a-zA-Z]{2,3}$/.test(e),
                    v: e
                }
            },
            link: function(e) {
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t) {
            e.insertComment = function(i) {
                ...
                o.innerHTML = t.item(e, i).replace(/http(s)?:\/\/cdn.onlyzyx.com\/static\//g, "/resource/static/"),
                e.ActivateCode(e);
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            e.nestQuery = function(t) {
                e.v.Query.doCloudQuery("select nick, comment, link, rid, isSpam, mailMd5, ip, objectId, ua from Comment where rid in (".concat(JSON.stringify(t).replace(/(\[|\])/g, ""), ") order by -createdAt")).then((function(t) {
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            ...
            e.parentQuery = function() {
                ...
                e.loading.show(),
                e.v.Query.doCloudQuery("select nick, comment, link, rid, isSpam, mailMd5, ip, objectId, ua from Comment where (rid='' or rid is not exists) and url='".concat(e.C.url, "' order by -createdAt limit ").concat((n - 1) * e.pageSize, ",").concat(e.pageSize)).then((function(r) {
                ...
                t && !t.classList.contains("loaded") && AV.Query.doCloudQuery("select nick, mail, comment, url from Comment where (rid='' or rid is not exists) order by -createdAt limit 0,10").then((function(n) {
                    ...
                    if (i) {
                        for (var r = "", o = 0; o < i; o++)
                            ...
                            a.default)(n[o].get("createdAt"), e.i18n) + "</span><span>" + n[o].get("comment").replace(/http(s)?:\/\/cdn.onlyzyx.com\/static\//g, "/resource/static/").replace(/<[^>]+>/gi, "").substr(0, 100) + "</span></a></li>";
                        t.innerHTML = r,
