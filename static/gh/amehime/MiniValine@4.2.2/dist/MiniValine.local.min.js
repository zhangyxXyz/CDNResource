        ...
        e.exports = function(e, t) {
            ...
            if (o && !e.config.closeUA) {
                ...
                try {
                    ...
                    ipInnerInit.referrerPolicy = "no-referrer"
                    ipInnerInit.src = 'https://whois.pconline.com.cn/jsFunction.jsp?&callback=f' + t.get("objectId") + '&level=2&ip=' + (ip && ip !== '' ? ip : '127.0.0.1');
                    try {
